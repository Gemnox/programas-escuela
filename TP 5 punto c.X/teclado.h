...
#define fila4		PORTBbits.RB4     //conectar al PIN4 del teclado
#define fila3		PORTBbits.RB5     //conectar al PIN6 del teclado
#define fila2		PORTBbits.RB6     //conectar al PIN7 del teclado
#define fila1		PORTBbits.RB7     //conectar al PIN2 del teclado
...
#define col1        TRISBbits.RB3     //conectar el PIN3 del teclado
